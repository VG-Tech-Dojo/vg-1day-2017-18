...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-18/takahashi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-18/takahashi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-18/takahashi/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	// ...
	s.Engine.GET("/takahashi", func(c *gin.Context) {
		c.HTML(http.StatusOK, "takahashi.html", gin.H{})
	})
